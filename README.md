...
### Крок 2: Надання дозволу "Дозволити скрипти користувачів"

Для коректної роботи розширення необхідно надати йому додатковий дозвіл.

1. Перейдіть на сторінку керування розширеннями у вашому браузері (наприклад, `chrome://extensions` або `edge://extensions`).
2. Знайдіть картку встановленого розширення або правий клік миші на іконку розширення та оберіть пункт Керувати розщиренням (як на ілюстрації).
3. На сторінці, що відкрилася, прокрутіть вниз до перемикача **"Дозволити скрипти користувачів" (Allow user scripts)**.
4. Переведіть цей перемикач у положення **Увімкнено**.

![Крок 2: увімкнення опції "Дозволити скрипти користувачів"](assets/enable-user-scripts.png)

### Крок 3: Відкриття Редактора Скриптів
...
![Крок 3: Натисніть на іконку розширення та оберіть вкладку JavaScript](assets/open_editor.png)

### Крок 4: Копіювання та Вставка Коду
...
![Крок 4: Вставка коду скрипта в редактор JavaScript](assets/paste_code.png)

### Крок 5: Збереження та Активація
...
![Крок 5: Збереження та активація скрипта](assets/save_and_enable.png)

### Крок 6: Запуск Аудиту
...
![Крок 6: Результат роботи Аудитора PNL на сторінці](assets/final_result.png)

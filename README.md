# 📈 Arbitrage Terminal PNL Auditor (v5.13)

**Розширений аудит PNL, групування за часом закриття та звірка обсягів для Arbitrage Terminal.**
...
1.  Перейдіть на сторінку історії PNL, де має працювати скрипт:
    ```
    [https://www.arbitterminal.online/history](https://www.arbitterminal.online/history)*
    ```
...
1.  **Скопіюйте повний вміст** файлу `auditor-5.13d.js` з цього репозиторію.
